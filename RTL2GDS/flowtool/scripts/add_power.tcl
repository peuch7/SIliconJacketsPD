...
connect_global_net VDD -type pg_pin -pin_base_name vpwrac
connect_global_net VDD -type pg_pin -pin_base_name vpwrpc
connect_global_net VSS -type pg_pin -pin_base_name vgnd
connect_global_net VSS -type pg_pin -pin_base_name vnb
connect_global_net VDD -type pg_pin -pin_base_name vpb
connect_global_net VDD -type pg_pin -pin_base_name vpwra
connect_global_net VDD -type pg_pin -pin_base_name vpwrm
connect_global_net VDD -type pg_pin -pin_base_name vpwrp
...
foreach i $mem_blocks {
    puts $i
    connect_global_net VDD -type pg_pin -pin vpwrac -sinst $i -override
    connect_global_net VDD -type pg_pin -pin vpwrpc -sinst $i -override
    connect_global_net VSS -type pg_pin -pin vgnd -sinst $i -override
    connect_global_net VSS -type pg_pin -pin vnb -sinst $i -override
    connect_global_net VDD -type pg_pin -pin vpb -sinst $i -override
    connect_global_net VDD -type pg_pin -pin vpwra -sinst $i -override
    connect_global_net VDD -type pg_pin -pin vpwrm -sinst $i -override
    connect_global_net VDD -type pg_pin -pin vpwrp -sinst $i -override
