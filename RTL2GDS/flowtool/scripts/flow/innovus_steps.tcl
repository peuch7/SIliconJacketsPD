...
create_flow_step -name add_tracks -owner cadence {
  ...
  if {[llength [get_db current_design .track_patterns]] == 0} {
    add_tracks -offsets {met1 horiz 0.1 met2 vert 0.2} -pitches {met1 horiz 0.2 met2 vert 0.3}
  }
}
#===========================================================================
# Flow: prects
...
create_flow_step -name add_fillers -owner cadence {
  ...
  if {[get_db add_fillers_cells] ne "" } {
    add_fillers -prefix FILLER -check_drc -fill_gap
  }
}
...
create_flow_step -name run_route -owner cadence {
  ...
  #   set_db place_global_cong_effort extreme
  #   reset_db -category si
  #   set_db si_analysis_type aae
  #   set_db extract_rc_engine post_route ; set_db extract_rc_effort_level medium
  #   set_db delaycal_enable_si true
  #   set_db timing_analysis_type ocv ; set_db timing_analysis_cppr both
  #   set_db design_flow_effort extreme
  #   set_db route_design_detail_min_slack_for_opt_wire 5.0
